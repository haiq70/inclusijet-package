...
def alpha_s(Q2:float, nf:int=4, Lambda:float=0.342207) -> float:
    """
    Implementing the one-loop running of the strong coupling as a function of Q^2. If the PDF set defined globally is one that contains listed alpha_s values at given Q, the function will read this instead. 
    ...
    # Return the value of the strong coupling based on the one-loop RGE
