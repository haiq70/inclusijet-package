...
- `main.py`: Main execution loop of the programme: included are functions visualising the results of the cross section calculation, based on various criteria. These have been used for performing cross-checks throughout the course of the development of the programme.